...
% Nothing to do here. Make sure you understand the function prprob
...
net1 = feedforwardnet(25);  % 25 hidden layers
view(net1)
...
% TO DO: as in the first network, create and train the second network

%% Testing Both Neural Networks

% Nothing to do here. Make sure you understand the plotting
